...
public class InBasketActivity extends AppCompatActivity {
    ...
    private ArrayList<Item> Items;              //ArrayList for inbasket Items
    private ArrayList<Item> logged;             //ArrayList for logged items

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_in_basket);

        //set activty title to In-Basket
        setTitle("In-Basket");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //inflate menu with inbasket items
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.optionNewItem)
        {
            ...
            startActivity(new Intent(InBasketActivity.this, NewItemActivity.class));
        }
    ...
    private void loadData(){
        ...
        Gson gson = new Gson();
        String json = sharedPreferences.getString("Inbasket List", null);
