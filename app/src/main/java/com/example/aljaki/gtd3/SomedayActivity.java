...
public class SomedayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set activty title to someday action
        setTitle("Someday Actions");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.optionNewItem)
        {
            ...
            startActivity(new Intent(SomedayActivity.this, NewItemActivity.class));
        }
    ...
    private void loadData(){
        ...
        Gson gson = new Gson();
        String json = sharedPreferences.getString("Someday List", null);
